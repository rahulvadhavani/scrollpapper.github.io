...
<head>
    ...
    <link href="{{url('assets/css/admin_app.min.css')}}" rel="stylesheet">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mx-auto">
                                <div class="p-5">
                                    ...
                                    <?php } ?>
                                    <form class="user" name="form" method='Post' action='{{URL::to('admin/login')}}'>
                                        @csrf
                                        ...
                                        <div class="text-center">
                                        <button class=" btn btn-primary px-5 mt-3" type="submit">Login</button>
                                        </div>
                                        <hr>
